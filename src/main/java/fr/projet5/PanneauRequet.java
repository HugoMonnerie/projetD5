...
public class PanneauRequet extends JPanel {
        ...
        public JPanel resultFoot(Connection db, String teamName)
        {
            ...
            java.util.List<String> valuesTF=new ArrayList<>();
            try {
            ...
            java.util.List<String> valuesPF;
            try {
            ...
            java.util.List<String> valuesMF=new ArrayList<>();
            try {
        ...
        public JPanel resultTennis(Connection db, String TennisName)
        {
            ...
            java.util.List<String> valuesPT;
            try {
